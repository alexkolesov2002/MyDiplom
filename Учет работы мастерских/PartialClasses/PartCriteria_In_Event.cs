...
namespace Учет_работы_мастерских
{
...

    {
        ...
        public static List<criteria_in_event> getlistCriteria(int index, int id_student)
        {
            List<criteria_in_event> FullListCriteria = BaseModel.BaseConnect.criteria_in_event.Where(x => x.id_event == index && x.id_student == id_student).ToList();
           ...
           // List<criteria_in_event> NewList = new List<criteria_in_event>();
            ...
            //var GroupJournalNew = from Event in FullListCriteria group Event by Event.id_student;
            ...
            //        }
            //        if (criteria_In_Event.rating != null)
            //        {
